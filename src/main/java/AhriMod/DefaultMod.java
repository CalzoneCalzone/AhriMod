...
import AhriMod.cards.*;
import AhriMod.characters.TheDefault;
import AhriMod.events.IdentityCrisisEvent;
import AhriMod.potions.PlaceholderPotion;
import AhriMod.relics.BottledPlaceholderRelic;
import AhriMod.relics.DefaultClickableRelic;
import AhriMod.relics.PlaceholderRelic;
import AhriMod.relics.PlaceholderRelic2;
import AhriMod.util.IDCheckDontTouchPls;
import AhriMod.util.TextureLoader;
import AhriMod.variables.DefaultCustomVariable;
import AhriMod.variables.DefaultSecondMagicNumber;
...
public class DefaultMod implements
    ...
    private static final String MODNAME = "Ahri, the Nine-Tailed Fox";
    private static final String AUTHOR = "Calzones"; // And pretty soon - You!
    private static final String DESCRIPTION = "Play as the nine-tailed fox from League of Legends.";
    ...
    private static final String ATTACK_DEFAULT_GRAY = "AhriModResources/images/512/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY = "AhriModResources/images/512/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY = "AhriModResources/images/512/bg_power_default_gray.png";
    
    private static final String ENERGY_ORB_DEFAULT_GRAY = "AhriModResources/images/512/card_default_gray_orb.png";
    private static final String CARD_ENERGY_ORB = "AhriModResources/images/512/card_small_orb.png";
    
    private static final String ATTACK_DEFAULT_GRAY_PORTRAIT = "AhriModResources/images/1024/bg_attack_default_gray.png";
    private static final String SKILL_DEFAULT_GRAY_PORTRAIT = "AhriModResources/images/1024/bg_skill_default_gray.png";
    private static final String POWER_DEFAULT_GRAY_PORTRAIT = "AhriModResources/images/1024/bg_power_default_gray.png";
    private static final String ENERGY_ORB_DEFAULT_GRAY_PORTRAIT = "AhriModResources/images/1024/card_default_gray_orb.png";
    
    // Character assets
    private static final String THE_DEFAULT_BUTTON = "AhriModResources/images/charSelect/DefaultCharacterButton.png";
    private static final String THE_DEFAULT_PORTRAIT = "AhriModResources/images/charSelect/DefaultCharacterPortraitBG.png";
    public static final String THE_DEFAULT_SHOULDER_1 = "AhriModResources/images/char/defaultCharacter/shoulder.png";
    public static final String THE_DEFAULT_SHOULDER_2 = "AhriModResources/images/char/defaultCharacter/shoulder2.png";
    public static final String THE_DEFAULT_CORPSE = "AhriModResources/images/char/defaultCharacter/corpse.png";
    
    //Mod Badge - A small icon that appears in the mod settings menu next to your mod.
    public static final String BADGE_IMAGE = "AhriModResources/images/Badge.png";
    
    // Atlas and JSON files for the Animations
    public static final String THE_DEFAULT_SKELETON_ATLAS = "AhriModResources/images/char/defaultCharacter/skeleton.atlas";
    public static final String THE_DEFAULT_SKELETON_JSON = "AhriModResources/images/char/defaultCharacter/skeleton.json";
    ...
    public void receiveEditCards() {
        ...
        new AutoAdd("AhriMod") // ${project.artifactId}
