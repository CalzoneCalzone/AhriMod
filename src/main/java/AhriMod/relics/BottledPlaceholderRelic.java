...
import AhriMod.patches.relics.BottledPlaceholderField;
import AhriMod.util.TextureLoader;

import java.util.Iterator;
import java.util.function.Predicate;

import static AhriMod.DefaultMod.makeRelicOutlinePath;
import static AhriMod.DefaultMod.makeRelicPath;
